...
const processSteps = [
  ...
  },
  {
    ...
    icon: Search,
    title: 'House Hunt',
    subtitle: 'Search and find your perfect home',
    description:
      "Once you've prequalified and know your price range, you're ready to go shopping. This is the time to put together your wish list of everything you'd want in your dream home. At Skyeview at Skye Canyon, we have a variety of floor plans to choose from, all in a beautiful master-planned community.",
